-- Populate user_profiles using auth.users directly
-- This version queries auth.users by email and uses auth.users.id as user_id

-- =============================================================================
-- IMPORTANT: This script assumes the foreign key references auth.users(id)
-- =============================================================================
...
SELECT 
  au.id, 'Apoorva', 29, 'Bangalore, India', 'Chennai, India', 'UX Designer', 'In a relationship',
...
SELECT 
  au.id, 'Chirag', 32, 'London, United Kingdom', 'Ahmedabad, India', 'Investment Banker', 'Married',
