...
export const TimelineNavigation: React.FC<TimelineNavigationProps> = ({
  ...
  return (
    <nav className="fixed left-0 top-16 bottom-0 w-64 bg-gradient-to-b from-card/80 to-background/80 backdrop-blur-md border-r-2 border-border p-8 overflow-y-auto z-40 hidden lg:block">
