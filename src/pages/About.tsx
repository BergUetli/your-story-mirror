    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-8 py-24 text-center space-y-8 animate-fade-in">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          You, Remembered is building the world&apos;s first resilient digital memory platform — preserving voices, stories, and guidance so loved ones can interact with them not just for years, but for generations.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-24">
        ...
        <div className="text-center mt-12">
          <p className="text-xl text-primary font-semibold">
            You, Remembered is the real-world continuation of these visions—not fiction, but technology with purpose.
          </p>
        </div>
      </div>
